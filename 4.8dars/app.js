...
//   if (K === 1) {
//     return true; // K = 1, hamda 1 ning istalgan darajasi 1 ga teng
//   }
...
// console.log(isPowerN(1, 1)); // true
// console.log(isPowerN(27, 3)); // true
// console.log(isPowerN(10, 3)); // false
